...
$id=mysqli_real_escape_string($conn, $_POST['id']);
                ...
                elseif($id){
                      ...
                      echo '<tbody><tr><td>
                              ...
                              <input type="text" value="'.$row[16].'" name="complaint_id" class="input-xlarge" disabled></td></tr>
                              <tr><td><label style="color:black;">Victim Email</label></td><td>
                              <input type="text" value="'.$row[14].'" name="victim_email" class="input-xlarge" disabled></td></tr>
                              <tr><td><label style="color:black;">Contact Number</label></td><td>
                              <input type="text" value="'.$row[15].'" name="victim_contact_no" class="input-xlarge" disabled></td></tr>
                        ...
                        if(isset($_SESSION['logindetails'])){
                          ...
                          <h3> Enter Your Comments : </h3>
                            <form action="includes/complaintquery.inc.php" method="POST">
                            <table><tr><td><input type="hidden" name="id" value="'.$row['0'].'" >



                          <div class="container">

                              <textarea class="form-control" rows="5"  id="comment" name="comment" required="" placeholder="Enter your comments here"></textarea>
                        ...
                        <tr>
                        <?php
                        $result1 = mysqli_query($con,"SELECT * FROM complaint_query where complaint_id='$row[0]' ORDER BY posted_on DESC ; ");
                        while($row = mysqli_fetch_array($result1))
                        {
                        echo '<td>Posted By : '.$row['user_id'].'</td><td>'.$row['posted_on'].'</td></tr><td colspan="2"><div class="well">'.$row['comment'].'</div></td></tr>';
